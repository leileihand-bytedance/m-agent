...
```bash
git add app/review/html_parser.py app/review/main.py app/review/task_execution.py app/review/README.md tests/test_review_html.py tests/test_review_task_execution.py tests/test_review_general.py tests/test_review_bot.py docs/development/README.md docs/development/architecture.md docs/development/TODO.md docs/agent-platform/README.md docs/capabilities/README.md docs/development/testing-and-delivery.md docs/history/designs-and-plans/plans/2026-07-16-review-html.md
...
```bash
git add app/review/html_parser.py app/review/output_formatter.py app/review/main.py tests/test_review_html.py tests/test_review_general.py app/review/README.md docs/development/README.md docs/development/architecture.md docs/development/TODO.md docs/capabilities/README.md docs/development/testing-and-delivery.md docs/history/designs-and-plans/plans/2026-07-16-review-html.md
